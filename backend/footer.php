<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> <i class="fas fa-envelope"></i> njchaudhari2005@gmail.com </p>
         <p> <i class="fas fa-map-marker-alt"></i> bhusawal, india - 425201 </p>
      </div>
   ...
   <p class="credit"> &copy; copyright  @ <?php echo date('Y'); ?> by <span>mr. nitin chaudhari</span> </p>
